...
namespace SeapowerMultiplayer
{
    ...
    public class MultiplayerUI : MonoBehaviour
    {
        ...
        private void RefreshUnitCounts()
        {
            ...
            foreach (var v in UnityEngine.Object.FindObjectsByType<Vessel>(FindObjectsSortMode.None))
            {
                if (isPvP && playerTf != null && v._taskforce == playerTf) _ownVessels++;
                else _enemyVessels++;
            }
            foreach (var s in UnityEngine.Object.FindObjectsByType<Submarine>(FindObjectsSortMode.None))
            {
                if (isPvP && playerTf != null && s._taskforce == playerTf) _ownSubs++;
                else _enemySubs++;
            }
            foreach (var a in UnityEngine.Object.FindObjectsByType<Aircraft>(FindObjectsSortMode.None))
            {
                if (isPvP && playerTf != null && a._taskforce == playerTf) _ownAir++;
                else _enemyAir++;
            }
            foreach (var h in UnityEngine.Object.FindObjectsByType<Helicopter>(FindObjectsSortMode.None))
            {
                if (isPvP && playerTf != null && h._taskforce == playerTf) _ownAir++;
                else _enemyAir++;
            }
            foreach (var l in UnityEngine.Object.FindObjectsByType<LandUnit>(FindObjectsSortMode.None))
            {
                if (isPvP && playerTf != null && l._taskforce == playerTf) _ownLand++;
                else _enemyLand++;
            }
            foreach (var m in UnityEngine.Object.FindObjectsByType<Missile>(FindObjectsSortMode.None))
            {
            ...
            foreach (var t in UnityEngine.Object.FindObjectsByType<Torpedo>(FindObjectsSortMode.None))
            {
